...
class SynSellLimit extends Component {
  ...
  changeHandler(eventSyn, eventPrice, i) {
    ...
    if (eventPrice == "") {
      ...
      this.setState({
        messagePrice: `Target price must be greater than ${(parseFloat(window.web3Ava.utils.fromWei(this.props.synPoolPrice[this.props.i].toString(), 'shannon')) * 10).toLocaleString('en-US', { maximumFractionDigits: 3 })}`,
        txSynValidAmount: false
      })
    } else {
      this.setState({
      ...
      <div id="content">
        ...
        <form className="mb-3" onSubmit={(event) => {
          ...
          <div style={{ minWidth: "300px" }}>
            <div className="mb-1 ml-1 float-left" style={{ color: 'black', fontSize: '16px', minWidth: "120px" }}><b>Order to Sell</b></div>
