               ...
               <div className="center mt-4" style={{ color: 'black' }}><big><b>&nbsp;! Attention:&nbsp;Please use Version 2 farm for higher yield!&nbsp;&nbsp;&gt;&gt;&nbsp;<Link to="/menu/v2/"><Buttons className="textDarkMedium" variant="outline" size="sm" >Switch to V2</Buttons></Link></b></big></div>
                ...
                <div className="ml-auto mr-auto mt-3" style={{ width: '1000px' }}>
                    <div className="">
                        ...
                        <span className="float-left">
                            <ButtonGroup>
                                <Buttons variant="text" size="small" color="inherit" as={Link} to="/menu/">Pangolin</Buttons>
                                <Buttons variant="outlined" size="small" color="inherit" as={Link} to="/menu/traderjoe/">Trader Joe</Buttons>
                            </ButtonGroup>
                        </span>
                        {/* <span className="float-right mr-4">
                            <ButtonGroup>
                                <Buttons variant="text" size="small" color="inherit" >Sort by</Buttons>
                            </ButtonGroup>
                        </span> */}
                    </div>
                    <br /><br />
                                                            ...
                                                            <div>
                                                                <div>
                                                                    <div className="float-left">
                                                                        ...
                                                                        }}>Uses: {this.props.poolSegmentInfo[1][i].platform} <img src="/images/link.png" style={{ marginBottom: "3px" }} height='12' alt="" /></div>
                                                                        <div className="textGrey exLink0" onClick={() => {
                                                                            window.open(this.props.poolSegmentInfo[1][i].getLPLink, '_blank')
                                                                        }}>Get {this.props.poolSegmentInfo[1][i].lpName} <img src="/images/link.png" style={{ marginBottom: "3px" }} height='12' alt="" /></div>
                                                                        <div className="textGrey exLink0" onClick={() => {
                                                                            window.open(this.props.bavaContract, '_blank')
                                                                        }}>View On Explorer <img src="/images/link.png" style={{ marginBottom: "3px" }} height='12' alt="" /></div>
                                                                    </div>
