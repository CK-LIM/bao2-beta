            ...
            <div id="content" style={{color: '#ff9a04' }}>
                ...
                <div className="ml-auto mr-auto mt-3" style={{ }}>
                    <div className="">
                        ...
                        <span className="float-left">
                            <ButtonGroup>
                                {/* <Button variant="outlined" size="small" color="inherit" as={Link} to="/menu/v2">Pangolin</Button> */}
                                <Buttons className="mr-1" variant="text" size="small" color="inherit" as={Link} to="/menu/v2">Pangolin</Buttons>
                                <Buttons className="mr-1" variant="outlined" size="small" color="inherit" as={Link} to="/menu/v2/kyber">KyberSwap</Buttons>
                                                        ...
                                                        <div>
                                                            <div>
                                                                <div className="float-left">
                                                                    ...
                                                                    }}>Uses: {this.props.poolSegmentInfoV2_3[2][i].platform} <img src="/images/link.png" style={{ marginBottom: "3px" }} height='12' alt="" /></div>
                                                                    <div className="textGrey exLink0" onClick={() => {
                                                                        window.open(this.props.poolSegmentInfoV2_3[2][i].getLPLink, '_blank')
                                                                    }}>Get {this.props.poolSegmentInfoV2_3[2][i].lpName} <img src="/images/link.png" style={{ marginBottom: "3px" }} height='12' alt="" /></div>
                                                                    <div className="textGrey exLink0" onClick={() => {
