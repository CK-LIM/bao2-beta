    ...
    return (
      <div id="content" style={{ marginTop: "0px" }}>
        <MediaQuery minWidth={771}>
          ...
          <div className="center" style={{ marginTop: "25px" }} >
            ...
            <Link className="exLink0" style={{ marginRight: '33px' }} to={{ pathname: "https://app.pangolin.exchange/" }} target="_blank">
              <div className="center mb-2"><img src="/images/pangolin.png" width="50" height="50" align="right" alt="" /></div>
            </Link>
            <Link className="exLink0" to={{ pathname: "https://kyberswap.com/#/about/" }} target="_blank">
              <div className="center mb-2"><img src="/images/kyber.png" width="50" height="50" align="right" alt="" /></div>
            </Link>
          </div>
          <MediaQuery minHeight={700}>
            <img src="/images/baklava_mainBottom_removebg.png" height="8%" width="100%" className="fixed-bottom" alt="" />
          </MediaQuery>
        </MediaQuery>
        ...
        <MediaQuery minWidth={301} maxWidth={770}>
          <div style={{ minWidth: "300px" }} >
            <div className="center">
              <img src="/images/baklava.png" width="160" height="160" className="" alt="" />
            </div>
            <div className="center text" style={{ fontSize: "45px" }}>BAKLAVA SPACE</div>
            ...
            <div className="center" style={{ marginTop: "25px" }} >
              ...
              <Link className="exLink0" style={{ marginRight: '33px' }} to={{ pathname: "https://app.pangolin.exchange/" }} target="_blank">
                <div className="center mb-2"><img src="/images/pangolin.png" width="45" height="45" align="right" alt="" /></div>
              </Link>
              <Link className="exLink0" to={{ pathname: "https://kyberswap.com/#/about/" }} target="_blank">
                <div className="center mb-2"><img src="/images/kyber.png" width="45" height="45" align="right" alt="" /></div>
              </Link>
            </div>
        ...
        <MediaQuery maxWidth={300}>
          <div style={{ minWidth: "300px" }}>
            <div className="text-center">
              <img src="/images/baklava.png" width="140" height="140" className="" alt="" />
            </div>
